function [PD, PF, Precision, F1, AUC, MCC] = CTDP(sources, labeledTarget, unlabeledTarget)
...
[PD, PF, Precision, F1, AUC, MCC] = Performance(unlabeledTarget(:,end), probPos*weights', threshold); % Call self-defined function Performance()
