function [ PD,PF,Precision,F1,AUC,Accuracy,G_measure,MCC,Balance, probPos] = DMDAJFR(source, target, parameter)
...
%%% parameter.lambda;
 ...
 try
     ...
     [PD,PF,Precision,F1,AUC,Accuracy,G_measure,MCC,Balance] = Performance(Y_tar(:,end), probPos); % Call Performance()
 catch
    PD=nan;PF=nan;Precision=nan;F1=nan;AUC=nan;Accuracy=nan;G_measure=nan;MCC=nan;Balance=nan;probPos=rand(size(target,1),1);
 end
end
